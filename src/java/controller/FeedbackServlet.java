...
public class FeedbackServlet extends HttpServlet {
    ...
    request.setAttribute("FeedbackP", feedbacks);
    request.getRequestDispatcher("aboutTS.jsp").forward(request, response);
}
    ...
    // Forward to the aboutTS.jsp to display feedback list
    request.getRequestDispatcher("aboutTS.jsp").forward(request, response);
}
