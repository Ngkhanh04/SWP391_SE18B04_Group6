...
public class LoginByGoogleServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        User currentUser;
        if (userDAO.checkLoginGoogle(googleUser.getEmail())) {
            int user_id = userDAO.getUserIdByEmail(googleUser.getEmail());
            currentUser = userDAO.getUserByUserId(user_id);
            session.setAttribute("currentUser", currentUser);
        } else {
            userDAO.addAccountByLoginGoogle(googleUser.getEmail());
            int user_id = userDAO.getUserIdByEmail(googleUser.getEmail());
            currentUser = userDAO.getUserByUserId(user_id);
            session.setAttribute("currentUser", currentUser);
        }
